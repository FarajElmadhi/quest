 ...
 <div class="btn-group">
	...
	<div class="dropdown-menu" role="menu">
		<a href="{{ aurl('/questions/'.$id.'/edit')}}" class="dropdown-item" ><i class="fas fa-edit"></i> {{trans('admin.edit')}}</a>
		<a href="{{ aurl('/questions/'.$id)}}" class="dropdown-item" ><i class="fa fa-eye"></i> {{trans('admin.show')}}</a>
