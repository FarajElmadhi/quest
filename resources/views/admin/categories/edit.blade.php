...
<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
    <div class="form-group">
        <div class="custom-control custom-switch">
            {!! Form::checkbox('status', '1',$categories->status == "1"?true:false ,['class'=>'custom-control-input','placeholder'=>trans('admin.status'),"id"=>"status"]) !!}
            {!! Form::label('status',trans('admin.status'),['class'=>'custom-control-label']) !!}
        </div>
    </div>
</div>
