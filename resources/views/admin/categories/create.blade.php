...
<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
    <div class="form-group">
        <div class="custom-control custom-switch">
            {!! Form::checkbox("status","1",old("status"),["class"=>"custom-control-input","placeholder"=>trans("admin.1"),"id"=>"status"]) !!}
            {!! Form::label("status",trans("admin.1"),["class"=>"custom-control-label"]) !!}
        </div>
    </div>
</div>
