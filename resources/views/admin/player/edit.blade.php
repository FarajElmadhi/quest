	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a href="{{aurl('player/'.$player->id)}}" class="dropdown-item" style="color:#343a40">
...
{!! Form::open(['url'=>aurl('/player/'.$player->id),'method'=>'put','id'=>'player','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">

<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('token',trans('admin.token'),['class'=>'control-label']) !!}
        {!! Form::text('token', $player->token ,['class'=>'form-control','placeholder'=>trans('admin.token')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('coins',trans('admin.coins'),['class'=>'control-label']) !!}
        {!! Form::text('coins', $player->coins ,['class'=>'form-control','placeholder'=>trans('admin.coins')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('time',trans('admin.time'),['class'=>'control-label']) !!}
        {!! Form::text('time', $player->time ,['class'=>'form-control','placeholder'=>trans('admin.time')]) !!}
    </div>
</div>
