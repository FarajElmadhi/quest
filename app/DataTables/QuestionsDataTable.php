...
class QuestionsDataTable extends DataTable
{
...
            ->addColumn('question_type', '{{ trans("admin.".$question_type) }}')
    ...
    {
        return Question::query()->with(['category_id',])->select("questions.*");
 ...
 [
				...
				[
                 'name'=>'correct',
                 'data'=>'correct',
                 'title'=>trans('admin.correct'),
		    ],
				[
                 'name'=>'questions.question_type',
                 'data'=>'question_type',
                 'title'=>trans('admin.question_type'),
		    ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
