...
class OnlineDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.online.buttons.actions')
    ...
    {
        return Online::query()->select("onlines.*");
...
[
				...
				[
                 'name'=>'token1',
                 'data'=>'token1',
                 'title'=>trans('admin.token1'),
		    ],
				[
                 'name'=>'token2',
                 'data'=>'token2',
                 'title'=>trans('admin.token2'),
		    ],
				[
                 'name'=>'quest_id',
                 'data'=>'quest_id',
                 'title'=>trans('admin.quest_id'),
		    ],
				[
                 'name'=>'ans1',
                 'data'=>'ans1',
                 'title'=>trans('admin.ans1'),
		    ],
				[
                 'name'=>'ans2',
                 'data'=>'ans2',
                 'title'=>trans('admin.ans2'),
		    ],
				[
                 'name'=>'winner',
                 'data'=>'winner',
                 'title'=>trans('admin.winner'),
		    ],
				[
                 'name'=>'game_id',
                 'data'=>'game_id',
                 'title'=>trans('admin.game_id'),
		    ],
            [
	                'name' => 'created_at',
	                'data' => 'created_at',
